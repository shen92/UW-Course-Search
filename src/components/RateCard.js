...
function RateCard(props) {
    ...
    const onRateRadioChange = (e) => {
      ...
      const subjectIndex = newPreferredHistorySubjects.findIndex(item => item.subject === course.subject);
      if (subjectIndex >= 0) {
        let newPreferredHistorySubject = newPreferredHistorySubjects[subjectIndex];
